#undef LASTRESISTERS_API
#undef LASTRESISTERS_VTABLE
...
#define UE_PROJECT_NAME LastResisters
...
#define LASTRESISTERS_VTABLE DLLEXPORT_VTABLE
#define LASTRESISTERS_API DLLEXPORT
