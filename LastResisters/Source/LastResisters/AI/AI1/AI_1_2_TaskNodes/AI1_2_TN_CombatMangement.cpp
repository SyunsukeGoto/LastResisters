...
#include "AI1_2_TN_CombatMangement.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "AI/AI1/AI1_AIController.h"
#include "AIController.h"

EBTNodeResult::Type UAI1_2_TN_CombatMangement::ExecuteTask(UBehaviorTreeComponent & OwnerComp, uint8 * NodeMemory)
{
...
void UAI1_2_TN_CombatMangement::ChangeStance(int _stance)
{
