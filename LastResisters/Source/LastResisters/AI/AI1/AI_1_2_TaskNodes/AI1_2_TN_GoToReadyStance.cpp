...
#include "AI1_2_TN_GoToReadyStance.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "AI/AI1/AI1_AIController.h"
#include "AIController.h"
#include "Misc/OutputDeviceNull.h"

EBTNodeResult::Type UAI1_2_TN_GoToReadyStance::ExecuteTask(UBehaviorTreeComponent & OwnerComp, uint8 * NodeMemory)
{
...
void UAI1_2_TN_GoToReadyStance::ChangeStance(int _stance)
{
