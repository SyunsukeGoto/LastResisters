...
#include "AI1_1_TN_GoingDownProcess.h"
...
EBTNodeResult::Type UAI1_1_TN_GoingDownProcess::ExecuteTask(UBehaviorTreeComponent & OwnerComp, uint8 * NodeMemory)
{
...
void UAI1_1_TN_GoingDownProcess::ChangeStance(int _stance)
{
