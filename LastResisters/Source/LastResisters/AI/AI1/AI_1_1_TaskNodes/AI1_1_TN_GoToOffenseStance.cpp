...
#include "AI1_1_TN_GoToOffenseStance.h"
...
EBTNodeResult::Type UAI1_1_TN_GoToOffenseStance::ExecuteTask(UBehaviorTreeComponent & OwnerComp, uint8 * NodeMemory)
{
...
void UAI1_1_TN_GoToOffenseStance::ChangeStance(int _stance)
{
