...
#include "AI1_1_TN_StateManagement.h"
...
EBTNodeResult::Type UAI1_1_TN_StateManagement::ExecuteTask(UBehaviorTreeComponent & OwnerComp, uint8 * NodeMemory)
{
...
void UAI1_1_TN_StateManagement::ChangeState(int _state)
{
