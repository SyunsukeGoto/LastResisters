...
#include "AI2_TaskNodes_GoToOffenseStance.h"
...
EBTNodeResult::Type UAI2_TaskNodes_GoToOffenseStance::ExecuteTask(UBehaviorTreeComponent & OwnerComp, uint8 * NodeMemory)
{
...
void UAI2_TaskNodes_GoToOffenseStance::ChangeStance(int _stance)
{
