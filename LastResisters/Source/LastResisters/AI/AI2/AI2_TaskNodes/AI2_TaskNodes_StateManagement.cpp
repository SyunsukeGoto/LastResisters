...
#include "AI2_TaskNodes_StateManagement.h"
...
EBTNodeResult::Type UAI2_TaskNodes_StateManagement::ExecuteTask(UBehaviorTreeComponent & OwnerComp, uint8 * NodeMemory)
{
...
void UAI2_TaskNodes_StateManagement::ChangeState(int _state)
{
